...
## Solutions
Helping and assisting customers comes in multiphase approaches and this is something that I have learned from my time at my current job. It is important to be able to think about the short term and long term implications of the issue to ensure that the customer is satisfied but also that in the future we don't spend time on the same type of issue.
...
- Should we introduce a monitor that allows us to see how often other customers are encountering the same issue?
